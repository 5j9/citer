...
class AdinebookTest(unittest.TestCase):
    ...
    def test_ab1(self):
        ...
        e = u'* {{یادکرد کتاب|نام خانوادگی=لانسکی|نام=ویکی|ترجمه=فیروزه دالکی و مژگان امیرفروغی|دیگران= کی وایت (تصويرگر)|کتاب=101 راه برای اینکه پدر بهتری باشید|ناشر=پیک ادبیات|سال=1386|ماه=شهریور|شابک=978-964-8165-81-4|زبان=fa|تاریخ بازبینی='
    ...
    def test_ab2(self):
        ...
        o = adinebook.AdineBook(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=کرسول|نام=جان|نام خانوادگی۲=کلارک|نام۲=ویکی پلانو|ترجمه=محسن نیازی و عباس زارعی|کتاب=روش های تحقیق تلفیقی|ناشر=علم و دانش|سال=1387|ماه=خرداد|شابک=978-964-2823-35-2|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_ab4(self):
        ...
        o = adinebook.AdineBook(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=کریمی|نام=نجمه|نام خانوادگی۲=یزدخواستی|نام۲=فروغ|نام خانوادگی۳=مختاری|نام۳=صفورا|کتاب=11 سپتامبر ... آرماگدون|ناشر=حدیث راه عشق|سال=1386|ماه=شهریور|شابک=978-964-95633-4-3|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_ab5(self):
        ...
        o = adinebook.AdineBook(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=نژاد|نام=یوسف علی یوسف|کتاب=فراهنجاری در مثنوی سرایی|ناشر=اردیبهشت|سال=1388|شابک=978-964-2656-34-9|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_ab6(self):
        ...
        o = adinebook.AdineBook(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=مونس|نام=حسین|ترجمه=حمیدرضا شیخی|کتاب=تاریخ و تمدن مغرب|ناشر=سازمان مطالعه و تدوین کتب علوم انسانی دانشگاهها|سال=1392|ماه=شهریور|شابک=978-964-530-036-2|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_ab7(self):
        ...
        o = adinebook.AdineBook(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=دیماتیو|نام=ام.رابین|نام خانوادگی ویراستار=جباری|نام ویراستار=کریم|ترجمه=محمد کاویانی|دیگران= کیانوش هاشمیان (زيرنظر)|کتاب=روانشناسی سلامت به ضمیمه نگرشی بر منابع اسلامی|ناشر=سازمان مطالعه و تدوین کتب علوم انسانی دانشگاهها|سال=1389|ماه=دی|شابک=978-964-459-398-7|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
...
class GooglebookTest(unittest.TestCase):
    ...
    def test_gb1(self):
        ...
        e = u'* {{یادکرد کتاب|نام خانوادگی=Arms|نام=W.Y.|کتاب=Digital Libraries|ناشر=MIT Press|سری=Digital libraries and electronic publishing|سال=2001|شابک=9780262261340|پیوند=http://books.google.com/books?id=pzmt3pcBuGYC&pg=PR11|زبان=en|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_gb3(self):
        ...
        o = googlebooks.GoogleBook(i)
        e1 = u'<ref>{{پک|Farrell|ک=Microsoft® Visual C# 2008 Comprehensive: An Introduction to Object-Oriented Programming|زبان=en|ص=588}}</ref>'
        e2 = u'* {{یادکرد کتاب|نام خانوادگی=Farrell|نام=J.|کتاب=Microsoft® Visual C# 2008 Comprehensive: An Introduction to Object-Oriented Programming|ناشر=Cengage Learning|شابک=9781111786199|پیوند=http://books.google.com/books?id=icMEAAAAQBAJ&pg=PA588|زبان=en|تاریخ بازبینی='
        self.assertIn(e1, o.ref)
        self.assertIn(e2, o.cite)
...
class NoormagsTest(unittest.TestCase):
    ...
    def test_nm1(self):
        ...
        e = u'* {{یادکرد ژورنال|نام خانوادگی=موسوی|نام=زهرا|عنوان=مقرنس در معماری|ژورنال=کتاب ماه هنر|شماره=45|سال=1381|صفحه=102–106|پیوند=http://www.noormags.com/view/fa/articlepage/104040|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)

    def test_nm2(self):
        i = 'http://www.noormags.com/view/fa/ArticlePage/454096'
        o = noormags.NoorMag(i)
        e = u'* {{یادکرد ژورنال|عنوان=زندگی نامه علمی دکتر کاووس حسن لی|ژورنال=شعر|شماره=62|سال=1387|صفحه=17–19|پیوند=http://www.noormags.com/view/fa/articlepage/454096|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)

    def test_nm3(self):
        i = 'http://www.noormags.com/view/fa/articlepage/261461'
        o = noormags.NoorMag(i)
        e = u'* {{یادکرد ژورنال|نام خانوادگی=ایرانی|نام=هوشنگ|نام خانوادگی۲=آ. ولف|نام۲=|عنوان=لوژیستیک|ژورنال=دانش|شماره=6|سال=1328|صفحه=316–324|پیوند=http://www.noormags.com/view/fa/articlepage/261461|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
...
class NoorlibTest(unittest.TestCase):
    ...
    def test_nl1(self):
        ...
        o = noorlib.NoorLib(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=مرتضی زبیدی|نام=محمد بن محمد|نام خانوادگی۲=شیری|نام۲=علی|کتاب=تاج العروس من جواهر القاموس|ناشر=دار الفکر|سری=تاج العروس من جواهر القاموس|جلد=10|سال=|پیوند=http://www.noorlib.ir/View/fa/Book/BookView/Image/18879|زبان=عربی|تاریخ بازبینی='
        self.assertIn(e, o.cite)
...
class IsbnTest(unittest.TestCase):
    ...
    def test_is1(self):
        ...
        e = u'* {{یادکرد کتاب|نام خانوادگی=Adkins|نام=Roy|کتاب=The war for all the oceans : from Nelson at the Nile to Napoleon at Waterloo|ناشر=Abacus|سال=2007|شابک=9780349119168|زبان=en|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_is2(self):
        ...
        i = '978-964-6736-71-9'
        o = isbn.Isbn(i, pure = True)
        e = u'* {{یادکرد کتاب|دیگران=بدیل بن علی خاقانی (شاعر)،  جهانگیر منصور (به اهتمام) و  بدیع الزمان فروزانفر (مقدمه)|کتاب=دیوان خاقانی شروانی|ناشر=نگاه|سال=1389|ماه=مرداد|شابک=978-964-6736-71-9|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
    ...
    def test_is3(self):
        ...
        i = '964-6736-34-3 '
        o = isbn.Isbn(i)
        e = u'* {{یادکرد کتاب|دیگران=سحر معصومی (به اهتمام)|کتاب=راز گل سرخ: نقد و گزیده شعرهای سهراب سپهری|ناشر=نگاه|سال=1386|ماه=بهمن|شابک=964-6736-34-3|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite) 
    ...
    def test_is4(self):
        ...
        o = isbn.Isbn(i)
        e = u'* {{یادکرد کتاب|نام خانوادگی=حافظ|نام=شمس الدین محمد|دیگران= رضا نظرزاده (به اهتمام)|کتاب=دیوان کامل حافظ همراه با فالنامه|ناشر=دیوان|سال=1385|ماه=آذر|شابک=964-92962-6-3|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.cite)
