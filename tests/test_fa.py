...
class AdinebookTest(unittest.TestCase):
    ...
    def test_ab1(self):
        ...
        e = '* {{یادکرد کتاب|نام خانوادگی=لانسکی|نام=ویکی|ترجمه=فیروزه دالکی و مژگان امیرفروغی|دیگران= کی وایت (تصويرگر)|عنوان=101 راه برای اینکه پدر بهتری باشید|ناشر=پیک ادبیات|سال=1386|ماه=شهریور|شابک=978-964-8165-81-4|زبان=fa}}'
    ...
    def test_ab2(self):
        ...
        o = adinebook.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=کرسول|نام=جان|نام خانوادگی۲=کلارک|نام۲=ویکی پلانو|ترجمه=محسن نیازی و عباس زارعی|عنوان=روش های تحقیق تلفیقی|ناشر=علم و دانش|سال=1387|ماه=خرداد|شابک=978-964-2823-35-2|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_ab3(self):
        ...
        o = adinebook.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=فخررحیمی|نام=علیرضا|نام خانوادگی۲=فخررحیمی|نام۲=الهام|دیگران= آرش نادرپور (مقدمه)،  امیر جابری (مقدمه)،  وحید شهبازیان (مقدمه) و  رضا مقدم (مقدمه)|عنوان=آموزش گام به گام پیکربندی مسیریابهای میکروتیک: آمادگی آزمون MTCNA|ناشر=نشرگستر|سال=1391|ماه=خرداد|شابک=978-600-5883-43-5|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_ab4(self):
        ...
        o = adinebook.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=کریمی|نام=نجمه|نام خانوادگی۲=یزدخواستی|نام۲=فروغ|نام خانوادگی۳=مختاری|نام۳=صفورا|عنوان=11 سپتامبر ... آرماگدون|ناشر=حدیث راه عشق|سال=1386|ماه=شهریور|شابک=978-964-95633-4-3|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_ab5(self):
        ...
        o = adinebook.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=نژاد|نام=یوسف علی یوسف|عنوان=فراهنجاری در مثنوی سرایی|ناشر=اردیبهشت|سال=1388|شابک=978-964-2656-34-9|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_ab6(self):
        ...
        o = adinebook.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=مونس|نام=حسین|ترجمه=حمیدرضا شیخی|عنوان=تاریخ و تمدن مغرب|ناشر=سازمان مطالعه و تدوین کتب علوم انسانی دانشگاهها|سال=1392|ماه=شهریور|شابک=978-964-530-036-2|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_ab7(self):
        ...
        o = adinebook.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=دیماتیو|نام=ام.رابین|نام خانوادگی ویراستار=جباری|نام ویراستار=کریم|ترجمه=محمد کاویانی|دیگران= کیانوش هاشمیان (زيرنظر)|عنوان=روانشناسی سلامت به ضمیمه نگرشی بر منابع اسلامی|ناشر=سازمان مطالعه و تدوین کتب علوم انسانی دانشگاهها|سال=1389|ماه=دی|شابک=978-964-459-398-7|زبان=fa}}'
        self.assertIn(e, o.ctnt)
...
class GooglebookTest(unittest.TestCase):
    ...
    def test_gb1(self):
        ...
        e = '* {{یادکرد کتاب|نام خانوادگی=Arms|نام=W.Y.|عنوان=Digital Libraries|ناشر=MIT Press|سری=Digital libraries and electronic publishing|سال=2000|شابک=978-0-262-26134-0|پیوند=http://books.google.com/books?id=pzmt3pcBuGYC&pg=PR11|زبان=en|تاریخ بازبینی='
        self.assertIn(e, o.ctnt)
...
class NoormagsTest(unittest.TestCase):
    ...
    def test_nm1(self):
        ...
        e = '* {{یادکرد ژورنال|نام خانوادگی=موسوی|نام=زهرا|عنوان=مقرنس در معماری|ژورنال=کتاب ماه هنر|شماره=45|سال=2002|صفحه=102–106|پیوند=http://www.noormags.ir/view/fa/articlepage/104040|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.ctnt)

    def test_nm2(self):
        i = 'http://www.noormags.com/view/fa/ArticlePage/454096'
        o = noormags.Response(i)
        e = '* {{یادکرد ژورنال|عنوان=زندگی نامه علمی دکتر کاووس حسن لی|ژورنال=شعر|شماره=62|سال=2008|صفحه=17–19|پیوند=http://www.noormags.ir/view/fa/articlepage/454096|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.ctnt)

    def test_nm3(self):
        i = 'http://www.noormags.com/view/fa/articlepage/261461'
        o = noormags.Response(i)
        e = '* {{یادکرد ژورنال|نام خانوادگی=ایرانی|نام=هوشنگ|نام خانوادگی۲=ولف|نام۲=آ.|عنوان=لوژیستیک|ژورنال=دانش|شماره=6|سال=1949|صفحه=316–324|پیوند=http://www.noormags.ir/view/fa/articlepage/261461|زبان=fa|تاریخ بازبینی='
        self.assertIn(e, o.ctnt)
...
class NoorlibTest(unittest.TestCase):
    ...
    def test_nl1(self):
        ...
        e = '* {{یادکرد کتاب|نام خانوادگی=مرتضی زبیدی|نام=محمد بن محمد|نام خانوادگی۲=شیری|نام۲=علی|عنوان=تاج العروس من جواهر القاموس|ناشر=دار الفکر|مکان=بيروت|سری=تاج العروس من جواهر القاموس|جلد=10|پیوند=http://www.noorlib.ir/View/fa/Book/BookView/Image/18879|زبان=عربی|تاریخ بازبینی='
        self.assertIn(e, o.ctnt)
...
class IsbnTest(unittest.TestCase):
    ...
    def test_is1(self):
        ...
        e = '* {{یادکرد کتاب|نام خانوادگی=Adkins|نام=Roy|عنوان=The war for all the oceans : from Nelson at the Nile to Napoleon at Waterloo|ناشر=Abacus|مکان=London|سال=2007|شابک=978-0-349-11916-8|زبان=en}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_is2(self):
        ...
        i = '978-964-6736-71-9'
        o = isbn.Response(i, pure=True)
        e = '* {{یادکرد کتاب|دیگران=بدیل بن علی خاقانی (شاعر)،  جهانگیر منصور (به اهتمام) و  بدیع الزمان فروزانفر (مقدمه)|عنوان=دیوان خاقانی شروانی|ناشر=نگاه|سال=1389|ماه=مرداد|شابک=978-964-6736-71-9|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_is3(self):
        ...
        i = '964-6736-34-3 '
        o = isbn.Response(i)
        e = '* {{یادکرد کتاب|دیگران=سحر معصومی (به اهتمام)|عنوان=راز گل سرخ: نقد و گزیده شعرهای سهراب سپهری|ناشر=نگاه|سال=1386|ماه=بهمن|شابک=964-6736-34-3|زبان=fa}}'
        self.assertIn(e, o.ctnt)
    ...
    def test_is4(self):
        ...
        o = isbn.Response(i)
        e = '* {{یادکرد کتاب|نام خانوادگی=حافظ|نام=شمس الدین محمد|دیگران= رضا نظرزاده (به اهتمام)|عنوان=دیوان کامل حافظ همراه با فالنامه|ناشر=دیوان|سال=1385|ماه=آذر|شابک=964-92962-6-3|زبان=fa}}'
        self.assertIn(e, o.ctnt)
