...
from lib.generator_en import clean_up_title, make_ref_name, sfn_cit_ref
...
def test_clean_up_title():
    # generated by citoid for https://search.worldcat.org/title/22239204
    assert (
        clean_up_title('73 amateur radio today | WorldCat.org')
