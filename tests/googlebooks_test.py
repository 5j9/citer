...
class GooglebooksTest(unittest.TestCase):
    ...
    def test_gb1(self):
        ...
        e = '* {{cite book|last=Arms|first=W.Y.|title=Digital Libraries|publisher=MIT Press|series=Digital libraries and electronic publishing|year=2000|isbn=978-0-262-26134-0|url=http://books.google.com/books?id=pzmt3pcBuGYC&pg=PR11|ref=harv|accessdate='
    ...
    def test_gb3(self):
        ...
        e2 = '* {{cite book|last=Farrell|first=J.|title=Microsoft Visual C# 2008 Comprehensive: An Introduction to Object-Oriented Programming|publisher=Cengage Learning|year=2009|isbn=978-1-111-78619-9|url=http://books.google.com/books?id=icMEAAAAQBAJ&pg=PA588|ref=harv|accessdate='
        self.assertIn(e1, o.sfnt)
        self.assertIn(e2, o.ctnt)
    ...
    def test_gb4(self):
        ...
        e2 = '* {{cite book|last=Šarčević|first=S.|title=New Approach to Legal Translation|publisher=Kluwer Law International|year=1997|isbn=978-90-411-0401-4|url=http://books.google.com/books?id=i8nZjjo_9ikC&pg=PA229|ref=harv|accessdate='
        self.assertIn(e1, o.sfnt)
        self.assertIn(e2, o.ctnt)
